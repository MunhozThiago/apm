...
function canCreate(shape, target, source, position) {
  ...
  // TODO: maybe delete this statement, because no need if collapsed pool isnt in the menu palette
  // cannot create a collapsed pool if there is no collaboration
  if (is(shape, 'bpmn:Participant') && !isExpanded(shape) && !is(target, 'bpmn:Collaboration')) {
    return false;
  }
