 ...
 */
function BpmnReplace(bpmnFactory, replace, selection, modeling, elementFactory) {
  ...
  function replaceElement(element, target, hints) {
    ...
    if (is(oldBusinessObject, 'bpmn:Participant') && !isExpanded(oldBusinessObject)) {
...
BpmnReplace.$inject = [ 'bpmnFactory', 'replace', 'selection', 'modeling', 'elementFactory' ];
