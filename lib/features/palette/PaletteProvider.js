...
PaletteProvider.prototype.getPaletteEntries = function(element) {
  ...
  function createCollapsedParticipant(event) {
    createParticipant(event, true);
  }
  ...
  assign(actions, {
    ...
    'create.participant-collapsed': {
      group: 'collaboration',
      className: 'bpmn-icon-participant',
      title: 'Create collapsed Participant',
      action: {
        dragstart: createCollapsedParticipant,
        click: createCollapsedParticipant
      },
